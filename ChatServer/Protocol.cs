...
namespace chat {
  ...
  public static partial class Protocol {
    ...
    static Protocol() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          "Cg5wcm90b2NvbC5wcm90bxIEY2hhdCIyCgxMb2dpblJlcXVlc3QSEAoIdXNl" + 
          "cm5hbWUYASACKAwSEAoIcGFzc3dvcmQYAiABKAkiHAoNTG9naW5SZXNwb25z" + 
          "ZRILCgN0dGwYASACKAciJgoGRnJpZW5kEgwKBG5hbWUYASACKAwSDgoGb25s" + 
          "aW5lGAIgASgIIjMKEkdldEZyaWVuZHNSZXNwb25zZRIdCgdmcmllbmRzGAEg" + 
          "AygLMgwuY2hhdC5GcmllbmQiNAoSU2VuZE1lc3NhZ2VSZXF1ZXN0EhAKCHJl" + 
          "Y2VpdmVyGAEgASgMEgwKBHRleHQYAiACKAkiMgoSRnJpZW5kTm90aWZpY2F0" + 
          "aW9uEgwKBG5hbWUYASACKAwSDgoGb25saW5lGAIgASgIIkYKE01lc3NhZ2VO" + 
          "b3RpZmljYXRpb24SDgoGc2VuZGVyGAEgAigJEgwKBHRleHQYAiACKAkSEQoJ" + 
          "dGltZXN0YW1wGAMgAigJIiMKE1dlbGNvbWVOb3RpZmljYXRpb24SDAoEdGV4" + 
          "dBgBIAIoDCJcCgdSZXF1ZXN0EiEKBWxvZ2luGAEgASgLMhIuY2hhdC5Mb2dp" + 
          "blJlcXVlc3QSLgoMc2VuZF9tZXNzYWdlGAIgASgLMhguY2hhdC5TZW5kTWVz" + 
          "c2FnZVJlcXVlc3QinAEKCFJlc3BvbnNlEg4KBnJlc3VsdBgBIAIoCBIVCg1s" + 
          "YXN0X3Jlc3BvbnNlGAIgAigIEhYKDmVycm9yX2Rlc2NyaWJlGAMgASgMEiIK" + 
          "BWxvZ2luGAQgASgLMhMuY2hhdC5Mb2dpblJlc3BvbnNlEi0KC2dldF9mcmll" + 
          "bmRzGAUgASgLMhguY2hhdC5HZXRGcmllbmRzUmVzcG9uc2UijAEKDE5vdGlm" + 
          "aWNhdGlvbhIoCgZmcmllbmQYASABKAsyGC5jaGF0LkZyaWVuZE5vdGlmaWNh" + 
          "dGlvbhImCgNtc2cYAiABKAsyGS5jaGF0Lk1lc3NhZ2VOb3RpZmljYXRpb24S" + 
          "KgoHd2VsY29tZRgDIAEoCzIZLmNoYXQuV2VsY29tZU5vdGlmaWNhdGlvbiK4" + 
          "AQoHTWVzc2FnZRIbCghtc2dfdHlwZRgBIAIoDjIJLmNoYXQuTVNHEhAKCHNl" + 
          "cXVlbmNlGAIgAigHEhIKCnNlc3Npb25faWQYAyABKAcSHgoHcmVxdWVzdBgE" + 
          "IAEoCzINLmNoYXQuUmVxdWVzdBIgCghyZXNwb25zZRgFIAEoCzIOLmNoYXQu" + 
          "UmVzcG9uc2USKAoMbm90aWZpY2F0aW9uGAYgASgLMhIuY2hhdC5Ob3RpZmlj" + 
          "YXRpb24qyQIKA01TRxISCg1Mb2dpbl9SZXF1ZXN0EJFOEhMKDkxvZ2luX1Jl" + 
          "c3BvbnNlEJJOEhMKDkxvZ291dF9SZXF1ZXN0EJNOEhQKD0xvZ291dF9SZXNw" + 
          "b25zZRCUThIWChFLZWVwYWxpdmVfUmVxdWVzdBCVThIXChJLZWVwYWxpdmVf" + 
          "UmVzcG9uc2UQlk4SGAoTR2V0X0ZyaWVuZHNfUmVxdWVzdBCXThIZChRHZXRf" + 
          "RnJpZW5kc19SZXNwb25zZRCYThIZChRTZW5kX01lc3NhZ2VfUmVxdWVzdBCZ" + 
          "ThIaChVTZW5kX01lc3NhZ2VfUmVzcG9uc2UQmk4SGQoTRnJpZW5kX05vdGlm" + 
          "aWNhdGlvbhChnAESGgoUTWVzc2FnZV9Ob3RpZmljYXRpb24QopwBEhoKFFdl" + 
          "bGNvbWVfTm90aWZpY2F0aW9uEKOcAQ==");
      pbd::FileDescriptor.InternalDescriptorAssigner assigner = delegate(pbd::FileDescriptor root) {
        descriptor = root;
        internal__static_chat_LoginRequest__Descriptor = Descriptor.MessageTypes[0];
        ...
        internal__static_chat_LoginResponse__Descriptor = Descriptor.MessageTypes[1];
        internal__static_chat_LoginResponse__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::chat.LoginResponse, global::chat.LoginResponse.Builder>(internal__static_chat_LoginResponse__Descriptor,
                new string[] { "Ttl", });
        internal__static_chat_Friend__Descriptor = Descriptor.MessageTypes[2];
        ...
        internal__static_chat_GetFriendsResponse__Descriptor = Descriptor.MessageTypes[3];
        internal__static_chat_GetFriendsResponse__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::chat.GetFriendsResponse, global::chat.GetFriendsResponse.Builder>(internal__static_chat_GetFriendsResponse__Descriptor,
                new string[] { "Friends", });
        internal__static_chat_SendMessageRequest__Descriptor = Descriptor.MessageTypes[4];
        ...
        internal__static_chat_FriendNotification__Descriptor = Descriptor.MessageTypes[5];
        internal__static_chat_FriendNotification__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::chat.FriendNotification, global::chat.FriendNotification.Builder>(internal__static_chat_FriendNotification__Descriptor,
                new string[] { "Name", "Online", });
        internal__static_chat_MessageNotification__Descriptor = Descriptor.MessageTypes[6];
        ...
        internal__static_chat_WelcomeNotification__Descriptor = Descriptor.MessageTypes[7];
        internal__static_chat_WelcomeNotification__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::chat.WelcomeNotification, global::chat.WelcomeNotification.Builder>(internal__static_chat_WelcomeNotification__Descriptor,
                new string[] { "Text", });
        internal__static_chat_Request__Descriptor = Descriptor.MessageTypes[8];
        internal__static_chat_Request__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::chat.Request, global::chat.Request.Builder>(internal__static_chat_Request__Descriptor,
                new string[] { "Login", "SendMessage", });
        internal__static_chat_Response__Descriptor = Descriptor.MessageTypes[9];
        internal__static_chat_Response__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::chat.Response, global::chat.Response.Builder>(internal__static_chat_Response__Descriptor,
                new string[] { "Result", "LastResponse", "ErrorDescribe", "Login", "GetFriends", });
        internal__static_chat_Notification__Descriptor = Descriptor.MessageTypes[10];
        internal__static_chat_Notification__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::chat.Notification, global::chat.Notification.Builder>(internal__static_chat_Notification__Descriptor,
                new string[] { "Friend", "Msg", "Welcome", });
        internal__static_chat_Message__Descriptor = Descriptor.MessageTypes[11];
  ...
  public sealed partial class LoginRequest : pb::GeneratedMessage<LoginRequest, LoginRequest.Builder> {
    ...
    private static readonly string[] _loginRequestFieldNames = new string[] { "password", "username" };
  ...
  public sealed partial class Request : pb::GeneratedMessage<Request, Request.Builder> {
    ...
    private static readonly string[] _requestFieldNames = new string[] { "login", "send_message" };
    ...
    public override void WriteTo(pb::ICodedOutputStream output) {
      ...
      if (hasLogin) {
        output.WriteMessage(1, field_names[0], Login);
      }
      if (hasSendMessage) {
        output.WriteMessage(2, field_names[1], SendMessage);
      }
      UnknownFields.WriteTo(output);
    }
  ...
  public sealed partial class Response : pb::GeneratedMessage<Response, Response.Builder> {
    ...
    private static readonly string[] _responseFieldNames = new string[] { "error_describe", "get_friends", "last_response", "login", "result" };
    private static readonly uint[] _responseFieldTags = new uint[] { 26, 42, 16, 34, 8 };
  ...
  public sealed partial class Notification : pb::GeneratedMessage<Notification, Notification.Builder> {
    ...
    private static readonly string[] _notificationFieldNames = new string[] { "friend", "msg", "welcome" };
    private static readonly uint[] _notificationFieldTags = new uint[] { 10, 18, 26 };
    ...
    public override void WriteTo(pb::ICodedOutputStream output) {
      ...
      if (hasWelcome) {
        output.WriteMessage(3, field_names[2], Welcome);
      }
      UnknownFields.WriteTo(output);
    }
